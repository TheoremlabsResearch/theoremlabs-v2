...
const partnerCategories: PartnerCategory[] = [
  ...
  {
    icon: <Landmark className="h-6 w-6 text-primary" aria-hidden="true" />,
...
const whyPartnerBenefits: WhyPartnerBenefit[] = [
  ...
  {
    icon: <MapPin className="h-8 w-8 text-primary" aria-hidden="true" />,
  ...
  {
    icon: <Handshake className="h-8 w-8 text-primary" aria-hidden="true" />,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="rounded-xl bg-card border border-border p-10 md:p-14 flex flex-col items-center gap-6">
            <SectionHeader
              ...
              title="Ready to build the Fintech AI ecosystem together?"
              subtitle="Whether you are a technology vendor, financial institution, systems integrator, or research organization - if you are serious about AI in financial services, let's talk about what we can build together."
              align="center"
            />
