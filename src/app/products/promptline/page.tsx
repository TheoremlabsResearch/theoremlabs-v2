...
const features: Feature[] = [
  {
    icon: <Phone className="h-6 w-6 text-[#F97316]" aria-hidden="true" />,
  ...
  {
    icon: <MessageSquare className="h-6 w-6 text-[#F97316]" aria-hidden="true" />,
  ...
  {
    icon: <Zap className="h-6 w-6 text-[#F97316]" aria-hidden="true" />,
  ...
  {
    icon: <Plug className="h-6 w-6 text-[#F97316]" aria-hidden="true" />,
...
const steps: Step[] = [
  ...
  {
    number: '02',
    icon: <Bot className="h-5 w-5 text-[#F97316]" aria-hidden="true" />,
            ...
            <div className="flex items-center justify-center">
              <div className="relative w-full max-w-sm">
                <div className="rounded-2xl border border-[#1E3A5F] bg-[#1A2B45] p-8 shadow-xl">
                  ...
                  <div className="mb-6 flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#F97316]/15">
                      <Phone className="h-5 w-5 text-[#F97316]" aria-hidden="true" />
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-[#F8FAFC]">PromptLine</p>
                      <p className="text-xs text-[#94A3B8]">Call in progress · 00:42</p>
                    </div>
                  ...
                  <div className="mb-5 flex items-end justify-center gap-1 h-10" aria-hidden="true">
                    {[3, 6, 9, 12, 8, 14, 10, 7, 12, 9, 5, 11, 8, 6, 10, 13, 7, 9, 11, 6].map(
                      (h, i) => (
                        <span
                          key={i}
                          className="w-1.5 rounded-full bg-[#F97316]/60"
                  ...
                  {/* Transcript line */}
                  <div className="rounded-lg bg-[#0F1B2D] px-4 py-3 text-xs text-[#94A3B8] border border-[#1E3A5F] mb-5">
                    &ldquo;I&apos;d like to check my account balance and the last three transactions&hellip;&rdquo;
                  </div>
                  <div className="rounded-lg bg-[#F97316]/10 px-4 py-3 text-xs text-[#F8FAFC] border border-[#F97316]/20 mb-5">
                ...
                <div className="absolute -right-4 -top-4 flex items-center gap-2 rounded-full border border-[#1E3A5F] bg-[#0F1B2D] px-3 py-1.5 shadow-lg">
                  <MessageSquare className="h-3.5 w-3.5 text-[#F97316]" aria-hidden="true" />
                  <span className="text-xs font-medium text-[#F8FAFC]">Voice + SMS</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="rounded-2xl border border-[#1E3A5F] bg-[#1A2B45] px-8 py-16 text-center md:px-16">
            ...
            <p className="mx-auto mb-10 max-w-xl text-base leading-relaxed text-[#94A3B8]">
              Talk to our team about your call volume, use cases, and integration requirements.
              We&apos;ll show you exactly what PromptLine can automate — and what it will cost you
              not to.
            </p>
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <CTAButton href="https://promptline.app" variant="secondary">
