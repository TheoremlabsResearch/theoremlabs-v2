...
const serviceAreas: ServiceArea[] = [
  {
    icon: <BrainCircuit className="h-6 w-6 text-primary" aria-hidden="true" />,
  ...
  {
    icon: <Coins className="h-6 w-6 text-primary" aria-hidden="true" />,
...
const differentiators: Differentiator[] = [
  {
    icon: <Lightbulb className="h-8 w-8 text-primary" aria-hidden="true" />,
    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="relative w-full overflow-hidden h-[420px]">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
          ...
          <p className="text-2xl md:text-3xl font-bold text-foreground max-w-xl leading-snug">
                ...
                {approachBullets.map((bullet) => (
                  <li key={bullet.text} className="flex items-start gap-3">
                    <CheckCircle2
                      ...
                      aria-hidden="true"
                    />
                    <span className="text-foreground text-base leading-relaxed">{bullet.text}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-6 list-none p-0 m-0">
            {serviceAreas.map((service) => (
              <li
                key={service.title}
                className={cn(
                  'bg-card border border-border rounded-xl p-7 flex flex-col gap-4',
      ...
      <section className="py-20 px-4 md:px-8 lg:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="rounded-xl bg-card border border-border p-10 md:p-14 flex flex-col items-center gap-6">
            <SectionHeader
              eyebrow="Get Started"
              title="Ready to turn strategy into an unfair advantage?"
              subtitle="Tell us where you are and where you want to go. We will bring the experience, the framework, and the team to get you there."
              align="center"
            />
